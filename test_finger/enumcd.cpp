...
--*/
{
    ...
    hDevInfo=SetupDiGetClassDevs(
        (LPGUID)&GUID_DEVCLASS_DISKDRIVE,//GUID_DEVCLASS_CDROM,
        NULL,
        NULL,
...
--*/
{
   ...
   //    PSTORAGE_ADAPTER_DESCRIPTOR         adpDesc;
    ...
    status=SetupDiEnumDeviceInterfaces(
        ...
        0,                       // Device Info data
        (LPGUID)&DiskClassGuid,//CdRomClassGuid, // Interface registered by driver
        Index,                   // Member
    ...
    if(strstr(szProductID,"SUPER DISK NF")){
        returned=0;
        long nBlockId=0x84;
        BYTE byPageID=0;
        ...
        sptwb.Spt.TargetId=1;
        sptwb.Spt.Lun=0;
        sptwb.Spt.CdbLength=16;//CDB6GENERIC_LENGTH;
        sptwb.Spt.SenseInfoLength=14;
        sptwb.Spt.DataIn=SCSI_IOCTL_DATA_IN;//SCSI_IOCTL_DATA_OUT
        sptwb.Spt.DataTransferLength=2048+4;//192;
        sptwb.Spt.TimeOutValue=200;
        sptwb.Spt.DataBufferOffset=
            offsetof(SCSI_PASS_THROUGH_WITH_BUFFERS,DataBuf);
        sptwb.Spt.SenseInfoOffset=
            offsetof(SCSI_PASS_THROUGH_WITH_BUFFERS,SenseBuf);
        sptwb.Spt.Cdb[0]=0xCF;//SCSIOP_INQUIRY;
        ...
        sptwb.Spt.Lun=0;
        sptwb.Spt.CdbLength=16;//CDB6GENERIC_LENGTH;
        sptwb.Spt.SenseInfoLength=0;//14;
        sptwb.Spt.DataIn=SCSI_IOCTL_DATA_IN;//SCSI_IOCTL_DATA_OUT
        sptwb.Spt.DataTransferLength=2048+4;//192;
        sptwb.Spt.TimeOutValue=200;
        sptwb.Spt.DataBufferOffset=
        ...
        sptwb.Spt.Cdb[2]=0x00;
        sptwb.Spt.Cdb[3]=LOBYTE(LOWORD(nBlockId));
        sptwb.Spt.Cdb[4]=HIBYTE(LOWORD(nBlockId));
        sptwb.Spt.Cdb[5]=LOBYTE(HIWORD(nBlockId));
        sptwb.Spt.Cdb[6]=HIBYTE(HIWORD(nBlockId));
        length=offsetof(SCSI_PASS_THROUGH_WITH_BUFFERS,DataBuf)+
            sptwb.Spt.DataTransferLength;
        ...
        BYTE byPageBuffer[2048];
        memset(byPageBuffer,0x31,sizeof(byPageBuffer));
        nBlockId=0x11;
        ...
        sptdwb.sptd.Lun=0;
        sptdwb.sptd.CdbLength=16;//CDB6GENERIC_LENGTH;
        sptdwb.sptd.SenseInfoLength=14;
        sptdwb.sptd.DataIn=SCSI_IOCTL_DATA_OUT;//SCSI_IOCTL_DATA_OUT
        sptdwb.sptd.DataTransferLength=sizeof(byPageBuffer);//192;
        sptdwb.sptd.TimeOutValue=20;
        sptdwb.sptd.DataBuffer=byPageBuffer;
        sptdwb.sptd.SenseInfoOffset=
            offsetof(SCSI_PASS_THROUGH_WITH_BUFFERS,SenseBuf);
        sptdwb.sptd.Cdb[0]=0xCF;//SCSIOP_INQUIRY;
        sptdwb.sptd.Cdb[1]=0x02;
        sptdwb.sptd.Cdb[2]=0x00;
        sptdwb.sptd.Cdb[3]=LOBYTE(LOWORD(nBlockId));
        sptdwb.sptd.Cdb[4]=HIBYTE(LOWORD(nBlockId));
        sptdwb.sptd.Cdb[5]=LOBYTE(HIWORD(nBlockId));
        sptdwb.sptd.Cdb[6]=HIBYTE(HIWORD(nBlockId));
...
GetMediaType(HANDLE hDevice,PUCHAR cdTypeString){
    ...
    switch(mediaTypes->DeviceType){
        ...
        case FILE_DEVICE_CD_ROM:
            strcpy((char*)cdTypeString,"CD-ROM");
            break;

        case FILE_DEVICE_DVD:
            strcpy((char*)cdTypeString,"DVD");
            break;

        default:
            strcpy((char*)cdTypeString,"Unknown");
            break;
    }
